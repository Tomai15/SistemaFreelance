    ...
    {   
        ...
        $projects = [
            ...
            [
                ...
                "nombre_proyecto" => "Sistema de Gestión de Inventarios",
                "descripcion" => "Desarrollo de un sistema para gestionar inventarios en tiempo real. Incluye módulos de entrada, salida y notificaciones de stock bajo.",
                "horas_estimadas" => 150,
                "precio" => 750,
                "urgencia_id" => 2,
                "confidencialidad_id" => 3,
            ...
            [
                "nombre_proyecto" => "Portal de Noticias en Línea",
                "descripcion" => "Desarrollo de un portal para publicar y gestionar noticias. Incluye soporte para comentarios, categorías, y un sistema de búsqueda avanzada.",
                "horas_estimadas" => 120,
                "precio" => 500,
                "urgencia_id" => 3,
                "confidencialidad_id" => 1,
            ...
            [
                "nombre_proyecto" => "Plataforma de Cursos en Línea",
                "descripcion" => "Construcción de una plataforma para gestionar cursos en línea con video lecciones, exámenes y certificaciones automáticas.",
                "horas_estimadas" => 180,
                "precio" => 1000,
                "urgencia_id" => 1,
                "confidencialidad_id" => 4,
